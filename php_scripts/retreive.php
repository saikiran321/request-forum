...
<?php
    ...
    while($row = mysql_fetch_assoc($result)) {
		...
		echo "<a type='button' class='btn btn-sm btn-success' href='accept.php/?id=".$row['id']."&auth_level=".$row['auth_level']."'>Accept</a>".
		     "<a type='button' class='btn btn-sm btn-danger' style='margin-left:5px;' href='decline.php/?id=".$row['id']."'>Decline</a>";
		echo "</div>";
